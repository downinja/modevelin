...
public class TibrvjDemoMessageHandler implements MessageHandler {

	private static final Logger LOGGER = Logger.getLogger(TibrvjDemoMessageHandler.class.getName()); // Or slf4j?
	...
	void setServer(final SocketServer server) {
		this.server = server;
	}
